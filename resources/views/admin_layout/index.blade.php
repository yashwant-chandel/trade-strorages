                        ...
                        <div class="nk-sidebar-menu" data-simplebar>
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{ url('admin-dashboard/blogs/add') }}" class="nk-menu-link"><span class="nk-menu-text">Add Blogs</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                               ...
                               <li class="nk-menu-item ">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{ url('admin-dashboard/site-content') }}" class="nk-menu-link"><span class="nk-menu-text">Home Page Setting</span></a>
                                        </li>
                                        <li class="nk-menu-item">
