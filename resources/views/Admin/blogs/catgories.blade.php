...
<div class="col-lg-6 d-none py-3" id="add-section">
                 <div class="card card-bordered h-100">
                     <div class="card-inner">
                         ...
                         <form action="{{ url('admin-dashboard/blogs/categories/submitProcc') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-xs">
                                    <ul class="link-list-plain">
                                        <li><a class="edit-btn" cat-name="{{ $cat->name ?? '' }}" cat-slug="{{ $cat->slug ?? '' }}" cat-id="{{ $cat->id ?? '' }}" href="">Edit</a></li>
                                        <li><a class="delete-btn" link="{{ url('admin-dashboard/blogs/categories/delete/') }}/{{ $cat->id ?? '' }}">delete</a></li>
                                    </ul>
                                </div>
                            </div>
                           </td>
